...
/**
 * A GL3xx clearing its backlog: one GTFRI carrying three positions (Number=3).
 * Built from REAL_GTFRI_22 by repeating its 11-field position block —
 * header 0..6, then 3 blocks, then the shared tail.
 */
export const GTFRI_22_MULTI =
  '+RESP:GTFRI,F50A01,015181000128000,,0,0,3' +
  ',1,0.0,0,811.5,-113.582319,37.063092,20221028094541,0310,0410,9909,06F23911' +
  ',1,0.0,0,812.0,-113.581000,37.064000,20221028094551,0310,0410,9909,06F23911' +
